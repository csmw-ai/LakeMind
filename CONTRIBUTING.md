...
1. 在 [GitHub Issues](https://github.com/csmw-ai/LakeMind/issues) 搜索是否已有相同问题。
...
1. 在 [GitHub Issues](https://github.com/csmw-ai/LakeMind/issues) 点击 **New Issue** → 选择 **Feature Request** 模板。
...
- **Bug / 功能请求**：[GitHub Issues](https://github.com/csmw-ai/LakeMind/issues)
- **代码贡献**：Pull Request
- **讨论**：[GitHub Discussions](https://github.com/csmw-ai/LakeMind/discussions)（如有）
